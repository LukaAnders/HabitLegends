...
export default function App() { return <BrowserRouter><Routes>
  ...
  <Route element={<ProtectedRoute />}><Route element={<GameLayout />}><Route path="/" element={<Kingdom />} /><Route path="/missoes" element={<TasksPage />} /><Route path="/jornada" element={<Placeholder />} /><Route path="/heroi" element={<Placeholder />} /><Route path="/inventario" element={<InventoryPage />} /><Route path="/mercado" element={<MarketPage />} /><Route path="/conquistas" element={<Placeholder />} /><Route path="/diario" element={<Placeholder />} /></Route></Route>
